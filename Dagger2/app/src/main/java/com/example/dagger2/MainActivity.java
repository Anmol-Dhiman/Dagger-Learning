...
//    private Car car;
    ...
    // the main drawback of the fielInject is that we have to make the variable public
    @Inject
    Car car, car2;
...
//       the DaggerCarComponent will be generated by dagger only after we build the project successfully
        CarComponent carComponent = ((ComponentProvider) getApplication()).getCarComponent();
